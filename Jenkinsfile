node {
    ...
    def feImageTag = "us.gcr.io/${project}/${websiteName}-frontend:${env.BRANCH_NAME}.${env.BUILD_NUMBER}"
    def feBuildDir = "angular-client"
    def beImageTag = "us.gcr.io/${project}/${websiteName}-backend:${env.BRANCH_NAME}.${env.BUILD_NUMBER}"
